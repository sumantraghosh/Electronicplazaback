package com.electronic.Electronicplazaback.config;
...
@Configuration
@ComponentScan("com.electronic.Electronicplazaback.*")
...
public class DBconfig 
{
	...
	public SessionFactory getSessionFactory(DataSource dataSource)
	{
		...
		sessionBuilder.scanPackages("com.electronic.Electronicplazaback.model");
